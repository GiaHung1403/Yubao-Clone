...
// function ImageViewScreen(props: any, ref: any) {
...
const ImageViewScreen = ({ route, navigation }) => {
	...
	return (
		<View style={{ flex: 1 }}>
			...
			<View style={{ paddingVertical: 10, paddingHorizontal: SPACING }}>
				<Text style={{ paddingVertical: 10, paddingHorizontal: SPACING }}>
					{'ahihi'}
				</Text>
